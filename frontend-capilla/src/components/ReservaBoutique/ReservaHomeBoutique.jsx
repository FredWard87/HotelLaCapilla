...
import { roomTypes, processPayment } from '../../services/roomServiceBoutique';
...
const SearchPanel = () => {
  ...
  return (
    <form className="luxury-search-panel2" onSubmit={handleSearch}>
